...
export default function DemoCallForm({ industries }: DemoCallFormProps) {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 sparkle-card p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <PhoneInput
            ...
            inputClassName="sparkle-input mt-1"
            countrySelectorStyleProps={{
              buttonClassName: "rounded-l-md border-r-0 bg-white/80 backdrop-blur-sm border border-gray-200"
            }}
          />
        </div>
        <div>
