...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseStyles = variant === 'sparkle' 
      ? 'sparkle-input'
      : 'px-4 py-2.5 border rounded-lg text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50'

    const stateStyles = variant === 'sparkle' 
      ? hasError 
