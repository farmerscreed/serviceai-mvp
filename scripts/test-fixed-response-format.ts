...
/**
 * Script to test the fixed webhook response format
 */
...
async function testFixedResponseFormat() {
...
// Run the test
testFixedResponseFormat()
  .then(() => {
    console.log('🎉 Fixed response format test completed!')
    process.exit(0)
  })
  .catch((error) => {
