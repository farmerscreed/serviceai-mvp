...
/**
 * Script to debug the organization lookup
 */
...
async function debugOrganizationLookup() {
  console.log('🔍 Debugging organization lookup...')
  ...
  try {
    ...
    console.error('❌ Error debugging organization lookup:', error)
    throw error
  }
}

// Run the debug
debugOrganizationLookup()
  .then(() => {
    console.log('🎉 Organization lookup debug completed!')
    process.exit(0)
  })
  .catch((error) => {
